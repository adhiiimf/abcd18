vr s = document.getElementsByClassName('cte');
var oneDay = 24 * 60 * 60 * 1000;
var firstDate = new Date("29 oct 2019 08:00:00");var secondDate = new Date();
...
}}}if(s[0].innerHTML <= -1) {clearInterval(i);document.getElementsByClassName('div-ct')[0].u innerHTML='<h1>Opening Ceremony</h1>'}}n   